<template>
  <section class="p-6 sm:p-20 sm:-mt-32 font-poppins">
    <div class="bg-[#DFD7F9] rounded-tl-[10rem] rounded-lg relative">
      ...
      <div class="space-y-12 px-12 py-28 sm:p-28 z-20">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
          <div
            class="bg-white px-6 py-3 flex space-x-3 items-center rounded-lg"
          >
            <svg
              width="21"
              height="18"
      ...
      >
        <g opacity="0.1">
          ...
          >
            <path
              d="M0.5 0.5H240C252.979 0.5 263.5 11.0213 263.5 24V351.022H50C22.6619 351.022 0.5 328.86 0.5 301.522V0.5Z"
              fill="url(#paint0_linear_1_461)"
              stroke="#6246E5"
            />
          </mask>
          <g mask="url(#mask0_1_461)">
            <circle cx="239.015" cy="178.32" r="91.8033" stroke="#6246E5" />
      ...
      <svg class="absolute -bottom-16 -right-12 -z-10" width="153" height="166" viewBox="0 0 153 166" fill="none" xmlns="http://www.w3.org/2000/svg">
